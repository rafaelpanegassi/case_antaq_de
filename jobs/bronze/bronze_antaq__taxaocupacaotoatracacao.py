...
def copy_atracacao_files():
    ...
    for subfolder in subfolders:
        ...
        for obj in contents:
            ...
            expected_prefix = f"{year_str}TaxaOcupacaoTOAtracacao_{year_str}-"
            if not filename.startswith(expected_prefix):
                continue

            destination_key = f"taxa/taxaocupacaotoatracacao/{filename}"
...
def main():
    load_dotenv()
    logger.info("Starting Taxa Ocupacao To Atracacao copy script.")
