...
def copy_file():
    ...
    source_key = f"register/Mercadoria_register-{today_str}.txt"
    destination_key = f"mercadoria/mercadoria/Mercadoria_register-{today_str}.txt"
...
def main():
    load_dotenv()
    logger.info("Starting copy script: Mercadoria")
    copy_file()
