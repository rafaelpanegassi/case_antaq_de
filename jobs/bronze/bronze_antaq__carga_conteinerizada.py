...
def copy_atracacao_files():
    ...
    for subfolder in subfolders:
        ...
        for obj in contents:
            ...
            expected_prefix = f"{year_str}Carga_Conteinerizada_{year_str}-"
            if not filename.startswith(expected_prefix):
                continue

            destination_key = f"carga/carga_conteinerizada/{filename}"
...
def main():
    load_dotenv()
    logger.info("Starting Carga Conteinerizada copy script.")
