...
def copy_atracacao_files():
    ...
    for subfolder in subfolders:
        ...
        for obj in contents:
            ...
            expected_prefix = f"{year_str}TemposAtracacao_{year_str}-"
            if not filename.startswith(expected_prefix):
                continue

            destination_key = f"tempos/temposatracacao/{filename}"
...
def main():
    load_dotenv()
    logger.info("Starting Tempos Atracacao copy script.")
