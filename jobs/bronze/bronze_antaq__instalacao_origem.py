...
def copy_file():
    ...
    source_key = f"register/Instalacao_Origem_register-{today_str}.txt"
    destination_key = f"instalacao/instalacao_origem/Instalacao_Origem_register-{today_str}.txt"
...
def main():
    load_dotenv()
    logger.info("Starting copy script: Instalacao_Origem")
    copy_file()
