...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("GoldCargaConteinerizadaUpsert")
        .master("local[*]")
    ...
    silver_table_path = f"s3a://{silver_bucket}/carga_conteinerizada/"
    gold_table_path   = f"s3a://{gold_bucket}/carga_conteinerizada/"
    ...
    if not table_exists:
        ...
        upsert_condition = (
            "t.idcarga = s.idcarga and t.cdmercadoriaconteinerizada = s.cdmercadoriaconteinerizada"
        )
        (
            delta_table.alias("t")
            .merge(
