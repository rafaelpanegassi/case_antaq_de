...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("GoldTemposAtracacaoParalisacaoUpsert")
        .master("local[*]")
    ...
    silver_table_path = f"s3a://{silver_bucket}/temposatracacaoparalisacao/"
    gold_table_path   = f"s3a://{gold_bucket}/temposatracacaoparalisacao/"
