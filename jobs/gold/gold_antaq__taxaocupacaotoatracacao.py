...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("GoldTaxaOcupacaoTOAtracacaoUpsert")
        .master("local[*]")
    ...
    silver_table_path = f"s3a://{silver_bucket}/taxaocupacaotoatracacao/"
    gold_table_path   = f"s3a://{gold_bucket}/taxaocupacaotoatracacao/"
