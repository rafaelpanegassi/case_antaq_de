...
if __name__ == "__main__":
    ...
    silver_table_path = f"s3a://{silver_bucket}/atracacao/"
    gold_table_path   = f"s3a://{gold_bucket}/atracacao/"
    ...
    if not table_exists:
        ...
        upsert_condition = "t.idatracacao = s.idatracacao and t.idberco = s.idberco"
