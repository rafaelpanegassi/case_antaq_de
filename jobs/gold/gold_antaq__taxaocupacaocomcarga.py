...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("GoldTaxaOcupacaoComCargaUpsert")
        .master("local[*]")
    ...
    silver_table_path = f"s3a://{silver_bucket}/taxaocupacaocomcarga/"
    gold_table_path   = f"s3a://{gold_bucket}/taxaocupacaocomcarga/"
