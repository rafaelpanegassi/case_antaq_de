...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("SilverTaxaOcupacaoTOAtracacaoDelta")
        .master("local[*]")
    ...
    bronze_path = f"s3a://{bronze_bucket}/taxa/taxaocupacaotoatracacao/*-{execution_date}.txt"
    ...
    delta_output_path = f"s3a://{silver_bucket}/taxaocupacaotoatracacao/"
    (
        df.write
        .format("delta")
        .mode("overwrite")
