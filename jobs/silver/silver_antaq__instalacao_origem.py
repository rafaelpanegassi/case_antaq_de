...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("SilverInstalacaoOrigemDelta")
        .master("local[*]")
    ...
    bronze_path = f"s3a://{bronze_bucket}/instalacao/instalacao_origem/*-{execution_date}.txt"
    ...
    delta_output_path = f"s3a://{silver_bucket}/instalacao_origem/"
    (
        df.write
        .format("delta")
        .mode("overwrite")
