...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("SilverTaxaOcupacaoComCargaDelta")
        .master("local[*]")
    ...
    bronze_path = f"s3a://{bronze_bucket}/taxa/taxaocupacaocomcarga/*-{execution_date}.txt"
    ...
    delta_output_path = f"s3a://{silver_bucket}/taxaocupacaocomcarga/"
    (
        df.write
        .format("delta")
        .mode("overwrite")
