...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("SilverTemposAtracacaoParalisacaoDelta")
        .master("local[*]")
    ...
    bronze_path = f"s3a://{bronze_bucket}/tempos/temposatracacaoparalisacao/*-{execution_date}.txt"
    ...
    delta_output_path = f"s3a://{silver_bucket}/temposatracacaoparalisacao/"
    (
        df.write
        .format("delta")
        .mode("overwrite")
