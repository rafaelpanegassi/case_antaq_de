...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("SilverCargaHidroviaDelta")
        .master("local[*]")
    ...
    bronze_path = f"s3a://{bronze_bucket}/carga/carga_hidrovia/*-{execution_date}.txt"
    ...
    delta_output_path = f"s3a://{silver_bucket}/carga_hidrovia/"
    (
        df.write
        .format("delta")
        .mode("overwrite")
