...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("SilverTemposAtracacaoDelta")
        .master("local[*]")
    ...
    bronze_path = f"s3a://{bronze_bucket}/tempos/temposatracacao/*-{execution_date}.txt"
    ...
    delta_output_path = f"s3a://{silver_bucket}/temposatracacao/"
    (
        df.write
        .format("delta")
        .mode("overwrite")
