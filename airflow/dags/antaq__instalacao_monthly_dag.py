...
with DAG(
    ...
    description="Unified pipeline to run instalacao scripts for Bronze, Silver, and Gold layers sequentially, dependent on crawler DAG",
    ...
    # Sensor to wait for the crawler DAG's final task to finish
    wait_for_crawler = ExternalTaskSensor(
        task_id="wait_for_crawler",
        external_dag_id="antaq__crawler_dag",  # Replace with your crawler DAG ID
    ...
    # Execution order: wait for crawler, then Bronze >> Silver >> Gold
