...
with DAG(
    dag_id="antaq__mercadoria_monthly_dag",
    default_args=default_args,
    description="Unified pipeline to run mercadoria scripts for Bronze, Silver, and Gold layers sequentially, dependent on crawler DAG",
    schedule_interval='0 12 1 * *',
    start_date=datetime(2023, 1, 1),
    catchup=False,
    tags=["antaq", "mercadoria", "monthly", "bronze", "silver", "gold"],
) as dag:
    ...
    with TaskGroup("bronze", tooltip="Bronze mercadoria tasks") as bronze_group:
    ...
    with TaskGroup("silver", tooltip="Silver mercadoria tasks") as silver_group:
        silver_scripts = [
            "silver_antaq__mercadoria.py",
            "silver_antaq__mercadoriaconteinerizada.py",
        ]
    ...
    with TaskGroup("gold", tooltip="Gold mercadoria tasks") as gold_group:
        gold_scripts = [
            "gold_antaq__mercadoria.py",
            "gold_antaq__mercadoriaconteinerizada.py",
        ]
