...
with DAG(
    dag_id="silver_antaq__temposatracacaoparalisacao_dag",
    default_args=default_args,
    description="Silver Tempos files to Silver Delta table",
    schedule_interval='0 12 1 * *',
    start_date=datetime(2023, 1, 1),
    catchup=False,
    tags=["silver", "temposatracacao", "paralisacao", "monthly", "antaq"],
) as dag:
